...
## 使用场景
**个人使用：** 日常记录工作素材，系统自动提炼生成高价值周报、月报、季报。不用手动整理零散素材，减少写报告的重复工作量，清晰呈现个人工作价值输出，方便管理者查阅。  <br>
**部门使用：** 自动聚合部门全员工作素材，依托 AI 按需智能生成部门级周报、月报、季报，大幅减轻部门负责人整理报告的负担；同时可以直观了解团队成员的工作开展情况。
